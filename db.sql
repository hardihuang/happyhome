...
--
-- Dumping data for table `hh_school`
--

LOCK TABLES `hh_school` WRITE;
/*!40000 ALTER TABLE `hh_school` DISABLE KEYS */;
INSERT INTO `hh_school` VALUES (1,'侯马二中'),(2,'侯马五中'),(3,'浍滨中学'),(4,'五零二中学');
/*!40000 ALTER TABLE `hh_school` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `hh_son`
--

DROP TABLE IF EXISTS `hh_son`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `hh_son` (
  `mid` int(11) NOT NULL,
...
--
-- Table structure for table `hh_totalFee`
--

DROP TABLE IF EXISTS `hh_totalFee`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `hh_totalFee` (
...
-- Dump completed on 2016-04-09 19:09:34
